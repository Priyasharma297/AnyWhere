...
const MeetYourMechanic = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center p-8 bg-gray-100 rounded-lg shadow-lg gap-5 animate-fadeIn">
      <div className="flex-1 pr-5 max-w-full lg:max-w-[50%] text-justify">
